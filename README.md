...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/GgkLmeCuxZ)
...
```sh
npx nx serve crewlingo
```

To create a production bundle:

```sh
npx nx build crewlingo
```

To see all available targets to run for a project, run:

```sh
npx nx show project crewlingo
```
